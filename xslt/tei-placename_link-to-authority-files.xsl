...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:bgn="http://bibliograph.net/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:genont="http://www.w3.org/2006/gen/ont#"
    ...
    xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.tei-c.org/ns/1.0"
    ...
    <xsl:template match="tei:revisionDesc" name="t_9">
        <xsl:copy>
            ...
            <xsl:element name="tei:change">
                ...
                <xsl:text>) and to GeoNames IDs to </xsl:text>
                <tei:gi>placeName</tei:gi>
